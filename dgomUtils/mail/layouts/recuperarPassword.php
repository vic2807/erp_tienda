                                            ...
                                            <div>
                                                ...
                                                <div style="line-height:200%;color:#555555;font-family:'Verdanaf', Georgia, Times, 'Times New Roman', serif; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 10px;">
                                                    <div style="font-size:16px;line-height:24px;font-family:'Verdana', Georgia, Times, 'Times New Roman', serif;color:#555555;text-align:left;">
                                                        <p style="margin: 0;font-size: 16px;line-height: 28px;text-align: center">
                                                            <span style="font-size: 24px; font-weight: bold; color: #2B3736; line-height: 48px;">Recuperar contraseña
                                                            </span>
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="line-height:200%;color:#555555;font-family:'Verdanaf', Georgia, Times, 'Times New Roman', serif; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 10px;">
                                                    <div style="line-height:24px;font-size:12px;color:#555555;font-family:'Verdanaf', Georgia, Times, 'Times New Roman', serif;text-align:left;">
                                                        <p style="margin: 0;font-size: 12px;line-height: 24px;text-align: justify;">
                                                            <span style="font-size: 16px; line-height: 32px;">Estimado <strong><?= $nombre ?>,</strong>
                                                            </span>
                                                        </p>
                                                        <p style="margin: 0;font-size: 12px;line-height: 24px;text-align: justify;">
                                                            <span style="font-size: 16px; line-height: 32px;">Se ha recibido la solicitud de recuperar su contraseña:
                                                            </span>
                                                        </p>
                                                        ...
                                                        <p style="margin: 0;font-size: 12px;line-height: 24px;text-align: justify;">
                                                            <span style="font-size: 16px; line-height: 32px;">Para cambiar su contraseña de click en el siguiente boton: 
                                                            </span>
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:30px;">
                                                ...
                                                <a href="<?= $url ?>" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: white; background-color: #6f88f9; border-radius: 6px; -webkit-border-radius: 6px; -moz-border-radius: 6px; max-width: 262px; width: 222px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 10px; padding-right: 20px; padding-bottom: 10px; padding-left: 20px; font-family: 'Verdanaf', Georgia, Times, 'Times New Roman', serif;mso-border-alt: none; font-weight: 300;">
                                                    <span style="font-size:12px;line-height:24px;">
                                                        <span style="font-size: 14px; line-height: 32px;" data-mce-style="font-size: 14px; line-height: 32px; color: #2B3736;">Recuperar contraseña
                                                        </span>
                                                    </span>
                                                </a>
