 ...
 */
class ModUsuariosEntUsuariosSearch extends ModUsuariosEntUsuarios
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_usuario', 'id_status', 'b_remember_me'], 'integer'],
            [['txt_token', 'txt_imagen', 'txt_username', 'txt_apellido_paterno', 'txt_apellido_materno', 'txt_auth_key', 'txt_password_hash', 'txt_password_reset_token', 'txt_email', 'txt_password', 'fch_creacion', 'fch_actualizacion'], 'safe'],
        ];
    }
